...
COMMENT ON COLUMN moment_attachments.position IS '附件在 Moment 中的显示顺序';

CREATE INDEX idx_moment_attachments_moment_id_position ON moment_attachments (moment_id, position);
